...
public class SearchClient extends JPanel implements ActionListener {
	...
	/**
	 * Update the text in the result list
	 * 
	 * @param lines the values to display as the result
	 */
	...
	/**
	 * Split result into row number and row text
	 * 
	 * @param lines the values to parse
	 * @return List of row numbers for display
	 */
	...
	/**
	 * Event triggered when button is clicked; Connects to the server
	 * to get the results, parses out the row numbers, and updates the
	 * display list. Also updates the header with hit count.
	 * 
	...
	private static void constructGUI() {
        ...
        // Set frame size, screen position, and show the client interface
